...
export function get(req, res, callback) {
...
export function post(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!data.content) {
            return yield helpers.noScriptErrors(req, res, '[[error:invalid-data]]', 400);
        }
        ...
        try {
            ...
            if (err instanceof Error) {
                yield helpers.noScriptErrors(req, res, err.message, 400);
            }
        }
    });
}
